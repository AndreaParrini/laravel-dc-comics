    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-uppercase fw-medium">
                ...
                <li class="nav-item">
                    <a class='nav-link {{ Route::currentRouteName() === 'comics.index' || Route::currentRouteName() === 'comics.show' || Route::currentRouteName() === 'guest.comics.show' || Route::currentRouteName() === 'guest.comics.index' ? 'bg-primary text-light' : '' }}'
